...
//         //send content through socket
//         socket?.current?.emit( SocketEvent.SEND_DOCUMENT_CHANGES, { content});
...
//                     dispatch( setDocument({ ...document, content: JSON.stringify(content) }));
//                 }
//                 catch(err:any ){
...
//             const editorState = EditorState.createWithContent(convertFromRaw(data.content));
//             console.log(data);
//             setEditorState( editorState);

//         }

//         socket?.current?.on(SocketEvent.RECEIVE_DOCUMENT_CHANGES, handleReceiveChange);
